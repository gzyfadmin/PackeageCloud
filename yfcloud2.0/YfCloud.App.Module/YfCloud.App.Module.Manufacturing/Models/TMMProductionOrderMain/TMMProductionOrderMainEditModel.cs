...
{
    /// <summary>
    /// T_MM_ProductionOrderMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TMMProductionOrderMainDbModel))]
    public class TMMProductionOrderMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TMMProductionOrderDetailEditModel> ChildList { get; set; }
    }
}
