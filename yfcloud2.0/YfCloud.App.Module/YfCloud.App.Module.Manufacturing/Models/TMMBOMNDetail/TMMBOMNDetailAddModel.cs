...
namespace YfCloud.App.Module.Manufacturing.Models.TMMBOMNDetail
{
    /// <summary>
    /// T_MM_BOMNDetail Add Model
    /// </summary>
    [UseAutoMapper(typeof(TMMBOMNDetailDbModel))]
    public class TMMBOMNDetailAddModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
