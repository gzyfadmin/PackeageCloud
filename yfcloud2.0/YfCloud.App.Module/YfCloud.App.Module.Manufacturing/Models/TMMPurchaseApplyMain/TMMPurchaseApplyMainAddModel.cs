///////////////////////////////////////////////////////////////////////////////////////
// File: TMMPurchaseApplyMainAddModel.cs
...
{
    /// <summary>
    /// T_MM_PurchaseApplyMain Add Model
    /// </summary>
    [UseAutoMapper(typeof(TMMPurchaseApplyMainDbModel))]
    public class TMMPurchaseApplyMainAddModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TMMPurchaseApplyDetailAddModel> ChildList { get; set; }
    }
}
