///////////////////////////////////////////////////////////////////////////////////////
// File: TMMPickApplyMainEditModel.cs
...
{
    /// <summary>
    /// T_MM_PickApplyMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TMMPickApplyMainDbModel))]
    public class TMMPickApplyMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TMMPickApplyDetailEditModel> ChildList { get; set; }
    }
}
