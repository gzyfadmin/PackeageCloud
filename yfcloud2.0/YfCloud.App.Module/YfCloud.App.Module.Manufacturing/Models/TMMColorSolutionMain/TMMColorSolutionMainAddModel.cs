///////////////////////////////////////////////////////////////////////////////////////
// File: TMMColorSolutionMainAddModel.cs
...
{
    /// <summary>
    /// T_MM_ColorSolutionMain Add Model
    /// </summary>
    [UseAutoMapper(typeof(TMMColorSolutionMainDbModel))]
    public class TMMColorSolutionMainAddModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TMMColorSolutionDetailAddModel> ChildList { get; set; }
    }
}
