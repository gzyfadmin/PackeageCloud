...
{
    /// <summary>
    /// T_PSM_PurchaseOrderMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TPSMPurchaseOrderMainDbModel))]
    public class TPSMPurchaseOrderMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TPSMPurchaseOrderDetailEditModel> ChildList { get; set; }
    }
}
