...
namespace YfCloud.App.Module.Warehouse.Services
{
    ...
    public class OtherAmount : ICalcuInventory
    {
        ...
        /// </summary>
        /// <param name="db"></param>
        public OtherAmount(IDbContext db)
        {
            _db = db;
        }
        ...
        public decimal CalcuInAndOut(TWMStaQuery tWMStaQuery)
        {
            ...
            tradeNum =  _db.Instance.Queryable<TWMOtherCountDbModel>().Where(p => p.MaterialId == tWMStaQuery.MaterialId && p.WarehouseId == tWMStaQuery.WarehouseId).
        ...
        {
            var details = _db.Instance.Queryable<TWMOtherWhMainDbModel, TWMOtherWhDetailDbModel, TBMMaterialFileDbModel>((t1, t2, t3) =>
             new object[] {
                   JoinType.Inner,
                   t1.ID == t2.MainId,
                   JoinType.Inner,
        ...
        {
            var details = _db.Instance.Queryable<TWMOtherWhSendMainDbModel, TWMOtherWhSendDetailDbModel, TBMMaterialFileDbModel>((t1, t2, t3) =>
             new object[] {
                   JoinType.Inner,
                   t1.ID == t2.MainId,
                   JoinType.Inner,
            ...
            if (tWMStaQuery.EditID != null && tWMStaQuery.OperateType == OperateEnum.Other)
            {
