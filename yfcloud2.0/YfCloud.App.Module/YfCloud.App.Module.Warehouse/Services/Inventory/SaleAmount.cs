...
namespace YfCloud.App.Module.Warehouse.Services.Inventory
{
    ...
    public class SaleAmount : ICalcuInventory
    {
        ...
        /// </summary>
        /// <param name="db"></param>
        public SaleAmount(IDbContext db)
        {
            _db = db;
        }
        ...
        {
            var details = _db.Instance.Queryable<TWMSalesMainDbModel, TWMSalesDetailDbModel, TBMMaterialFileDbModel>((t1, t2, t3) =>
            new object[] {
                   JoinType.Inner,
                   t1.ID == t2.MainId,
                   JoinType.Inner,
            ...
            if (tWMStaQuery.EditID != null && tWMStaQuery.OperateType == OperateEnum.Sale)
            {
