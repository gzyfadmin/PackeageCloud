///////////////////////////////////////////////////////////////////////////////////////
// File: TWMOtherWhMainAddModel.cs
...
{
    /// <summary>
    /// T_WM_OtherWhMain Add Model
    /// </summary>
    [UseAutoMapper(typeof(TWMOtherWhMainDbModel))]
    public class TWMOtherWhMainAddModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMOtherWhDetailAddModel> ChildList { get; set; }
    }
}
