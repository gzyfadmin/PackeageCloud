///////////////////////////////////////////////////////////////////////////////////////
// File: TWMOtherWhSendMainEditModel.cs
...
{
    /// <summary>
    /// T_WM_OtherWhSendMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TWMOtherWhSendMainDbModel))]
    public class TWMOtherWhSendMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMOtherWhSendDetailEditModel> ChildList { get; set; }
    }
}
