///////////////////////////////////////////////////////////////////////////////////////
// File: TWMDeficitMainEditModel.cs
...
{
    /// <summary>
    /// T_WM_DeficitMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TWMDeficitMainDbModel))]
    public class TWMDeficitMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMDeficitDetailEditModel> ChildList { get; set; }
    }
}
