///////////////////////////////////////////////////////////////////////////////////////
// File: TWMPurchaseMainEditModel.cs
...
{
    /// <summary>
    /// T_WM_PurchaseMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TWMPurchaseMainDbModel))]
    public class TWMPurchaseMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMPurchaseDetailEditModel> ChildList { get; set; }
    }
}
