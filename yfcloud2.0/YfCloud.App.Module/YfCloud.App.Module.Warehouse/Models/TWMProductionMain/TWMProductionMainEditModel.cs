///////////////////////////////////////////////////////////////////////////////////////
// File: TWMProductionMainEditModel.cs
...
{
    /// <summary>
    /// T_WM_ProductionMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TWMProductionMainDbModel))]
    public class TWMProductionMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMProductionDetailEditModel> ChildList { get; set; }
    }
}
