///////////////////////////////////////////////////////////////////////////////////////
// File: TWMProductionWhMainEditModel.cs
...
{
    /// <summary>
    /// T_WM_ProductionWhMain Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TWMProductionWhMainDbModel))]
    public class TWMProductionWhMainEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// </summary>
        [Required]
        public List<TWMProductionWhDetailEditModel> ChildList { get; set; }
    }
}
