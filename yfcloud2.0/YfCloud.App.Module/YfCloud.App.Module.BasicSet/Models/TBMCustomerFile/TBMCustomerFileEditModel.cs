///////////////////////////////////////////////////////////////////////////////////////
// File: TBMCustomerFileEditModel.cs
...
{
    /// <summary>
    /// T_BM_CustomerFile Edit Model
    /// </summary>
    [UseAutoMapper(typeof(TBMCustomerFileDbModel))]
    public class TBMCustomerFileEditModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// 明细集合
        /// </summary>
        public List<TBMCustomerContactEditModel> ChildList { get; set; }
    }
}
