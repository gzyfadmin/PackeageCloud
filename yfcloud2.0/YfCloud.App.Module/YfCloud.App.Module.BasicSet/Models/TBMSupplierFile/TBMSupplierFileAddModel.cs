///////////////////////////////////////////////////////////////////////////////////////
// File: TBMSupplierFileAddModel.cs
...
{
    /// <summary>
    /// T_BM_SupplierFile Add Model
    /// </summary>
    [UseAutoMapper(typeof(TBMSupplierFileDbModel))]
    public class TBMSupplierFileAddModel : LogModelBase
    {
        /// <summary>
        /// 主键自增长
        /// </summary>
        ...
        /// 明细集合
        /// </summary>
        public List<TBMSupplierContactAddModel> ChildList { get; set; }
    }
}
