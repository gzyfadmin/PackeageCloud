...
namespace YfCloud.Framework.OrderGenerator
{
    ...
    public class MRGenerator:ICodeMaker
    {
        public string ProvideName { get { return "MR"; } }
        ...
        /// </summary>
        /// <param name="db"></param>
        public MRGenerator(IDbContext db)
        {
            _db = db;
        }
        ...
        public static string CreateNo(int CompanyID)
        {
            ...
            string key = string.Format(CacheKeyString.LockAutoCodeMR, CompanyID);
            string datekey = string.Format(CacheKeyString.LockAutoMR_date, CompanyID);
            ...
            var result = redis.LockRelease(key, TimeSpan.FromSeconds(10), () =>
            {
                ...
                return "MR" + dateSno.DateStr + dateSno.SNO.ToString().PadLeft(4, '0');
            });
