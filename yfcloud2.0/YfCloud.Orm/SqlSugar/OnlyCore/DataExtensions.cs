...
namespace SqlSugar
{
    ...
    /// MyCat数据填充器
    /// </summary>
    public class MyCatDataAdapter : IDataAdapter
    {
        private MyCatCommand command;
        private string sql;
        private MyCatConnection _sqlConnection;
        ...
        /// </summary>
        /// <param name="command"></param>
        public MyCatDataAdapter(MyCatCommand command)
        {
            this.command = command;
        }
        /// <summary>
        ...
        /// <param name="sql"></param>
        /// <param name="_sqlConnection"></param>
        public MyCatDataAdapter(string sql, MyCatConnection _sqlConnection)
        {
            this.sql = sql;
            this._sqlConnection = _sqlConnection;
        }
        ...
        /// SelectCommand
        /// </summary>
        public MyCatCommand SelectCommand
        {
            get
            {
                if (this.command == null)
                {
                    this.command = new MyCatCommand(this.sql, this._sqlConnection);
                }
                return this.command;
            }
            set
