    ...
    public partial class MyCatQueryBuilder : QueryBuilder
    {
        ...
        public override string GetWhereValueString
        {
            get
            {
                ...
                {
                    return string.Join(UtilConstants.Space, this.WhereInfos).Replace("`", "");
                }
            }
        }
        ...
        public override string GetGroupByString
        {
            get
            {
                ...
                {
                    return this.GroupByValue.Replace('`',' ') + UtilConstants.Space;
                }
                return this.GroupByValue.Replace("`", "");
            }
        }

        public override string HavingInfos
        {
            get
            {
                return _HavingInfos.Replace("`", ""); 
            }
            set
            {
                _HavingInfos = value;
        ...
        public override string GetOrderByString
        {
            get
            {
                ...
                {
                    return this.OrderByValue.Replace("`", ""); ;
                }
            }
        }
