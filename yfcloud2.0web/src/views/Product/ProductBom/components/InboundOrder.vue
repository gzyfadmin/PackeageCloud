        ...
        <el-header id="elheader" class="header" height="auto">
          <el-form ref="dtData" label-width="76px" class="FormInput" inline label-position="left">
            ...
            <el-form-item label="包型名称：">
              <el-select placeholder="请选择" v-model="dtData.packageId" filterable @change="getMainListIndex"  style="width:200px">
...
export default {
  ...
  methods: {
    ...
    getMainList() {
      ...
      this.tableData = [];
      request({
        url: "manufacturing/api/TMMBOMTempMain/GetMainList",
        method: "GET",
