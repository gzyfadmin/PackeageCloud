      ...
      <el-header id="elheader" class="header" height="auto">
        <el-form ref="dtData" label-width="76px" class="FormInput" inline label-position="left">
          <el-form-item label="订单单号：">
            ...
            >
            <i slot="suffix" class="el-input__icon el-icon-search" @click="getMainList(pageIndex=1)"></i>
            </el-input>
          </el-form-item>
...
if (this.dtData.orderNo!="") {
     list.push({
      ...
      // if (formatDate(this.dtData.orderDate) != "") {
      //   list.push({
      //     column: "orderDate",
      //     content: formatDate(this.dtData.orderDate),
      //     condition: 6
      //   });
      // }
      if (this.dtData.orderDate != null) {
        if (this.dtData.orderDate[0]) {
          ...
          list.push({
            column: "orderDate",
            content: this.dtData.orderDate[0]
              ? startDate + "," + endDate
              : "",
            condition: 10
          });
