  ...
  >
    ...
    <el-main class="wmltable" id="elmain">
      ...
      >
        ...
        <!-- <el-table-column prop="warehousingOrderNo" label="入库单号" width="150" /> -->
        ...
        <!-- <el-table-column prop="purchaseOrder" label="采购单号" width="150"/> -->
        <el-table-column prop="purchaseOrder" label="采购单号" width="150">
          <template slot-scope="scope">
            <div class="link" @click="goPage(scope.row,4)">{{ scope.row.purchaseOrder }}</div>
          </template>
        </el-table-column>
...
export default {
  name: "viewsinventoryPurchasingindexvue",
  components: {
    Pagination
  },
  filters: {
  ...
  async activated() {
    ...
    this.pathData = "viewsinventoryPurchaseOrderindexvue";
  },
  mounted() {
    this.setStyle();
    this.showtab = false;
  ...
  methods: {
    ...
    getMainList() {
      ...
      this.tableData = [];
      request({
        url: "warehouse/api/TWMPurchaseMain/GetMainList",
        method: "GET",
