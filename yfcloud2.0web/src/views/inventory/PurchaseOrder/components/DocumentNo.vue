      ...
      >
        <el-header id="elheader" class="header" height="auto">
          <el-form ref="dtData" label-width="90px" class="FormInput" inline label-position="right">
            ...
            <!-- <el-form-item class="formItem" label="供应商名称：" prop="WarehousingType">
              <el-select
        ...
        <div style="height:400px;overflow:auto;">
          ...
          >
            ...
            <el-table-column
              ...
              width="70"
              fixed="right"
              v-if="(btnAip.stopware&&btnAip.stopware.buttonCaption)"
            >
              <template slot-scope="scope">
                <el-tooltip
                  v-if="btnAip.stopware&&btnAip.stopware.buttonCaption"
                  class="item"
                  effect="light"
                  :content="btnAip.stopware.buttonCaption"
                  placement="top-start"
                  :open-delay="200"
                >
                  <el-button
  ...
  methods: {
    StopReceipt(row, state) {
      this.$confirm("是否终止", {
        ...
        .then(() => {
          var URL = "";
          URL = "/purchase/api/TPSMPurchaseOrderMain/StopWare";
    ...
    getMainList() {
      ...
      var orderConditions = [];
      var list = [
        { column: "transferStatus", content: 1, condition: 0 }
      ];
