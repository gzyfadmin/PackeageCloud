      ...
      <div class="middleWidth">
        ...
        >
          <el-form-item class="formItem disableType" label="领料部门：">
            <!-- <el-cascader
              v-model="dtData.deptId"
              style="width:100%"
              :options="allDept"
              :props="{ checkStrictly:true,value:'actualId',label:'pickDeptName' }"
              disabled
            />-->
            <div class="falseIptop">{{ dtData.pickDeptName?dtData.pickDeptName:"&nbsp;" }}</div>
          </el-form-item>
          ...
          <el-form-item class="formItem disableType" label="日期：">
          ...
          <el-form-item class="formItem disableType" label="领料单号：">
    ...
    <el-main>
      ...
      <div v-show="popoverState" class="findBox" :style="popoverStyle" @click.stop="1==1">
        <el-table :data="materielData" :height="250" @row-click="rowClick">
          ...
          <el-table-column prop="produceUnitName" label="基本计量单位" />
        </el-table>
        <Pagination
...
export default {
  ...
  methods: {
    ...
    async rowClick(row) {
      ...
      // dicValue: "物料12" -->
      // id: 50
      // materialCode: "1909051459058480005"
      // materialName: "物料12"
        ...
        if (res.code === 0) {
          ...
          this.dtData.auditTime =
            res.data[0].auditTime != null
              ...
              : "";
          this.dtData.pickDeptName = res.data[0].pickDeptName;
