      ...
      >
        ...
        <div style="height:400px;overflow:auto;">
          ...
          >
            ...
            <el-table-column prop="applyDate" label="订单日期" sortable="custom">
              <template slot-scope="scope">{{scope.row.applyDate|formatTDate}}</template>
            </el-table-column>

            <el-table-column prop="pickNo" label="订单单号" width="150" sortable="custom" />
...
export default {
  ...
  methods: {
    ...
    getMainList() {
      ...
      // if (formatDate(this.dtData.applyDate) != "") {
      //   list.push({
      //     column: "applyDate",
      //     content: formatDate(this.dtData.applyDate),
      //     condition: 6
      //   });
      // }
      ...
      this.tableData = [];
      request({
        // manufacturing/api/TMMPickApplyMain/GetMainList
