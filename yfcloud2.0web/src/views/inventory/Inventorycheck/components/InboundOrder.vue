    ...
    <div
      ...
      <div style="height:400px;overflow:auto;">
        ...
        >
          ...
          <el-table-column prop="inventoryDate" label="盘点日期" sortable='custom'>
            <template slot-scope="scope">{{scope.row.inventoryDate|formatTDate}}</template>
          </el-table-column>

          <el-table-column prop="inventoryOrder" label="盘点单号" width="150" sortable='custom' />
...
export default {
  ...
  methods: {
    ...
    if(this.dtData.warehousingOrder){
      ...
      // ];
      // if (formatDate(this.dtData.inventoryDate) != "") {
      //   list.push({
      //     column: "inventoryDate",
      //     content: formatDate(this.dtData.inventoryDate),
      //     condition: 6
      //   });
      // }
