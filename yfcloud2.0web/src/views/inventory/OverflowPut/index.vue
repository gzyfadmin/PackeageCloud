  ...
  >
    <el-header id="elheader" class="header headerBd" height="auto">
      ...
      <el-form :label-position="labelPosition" label-width="76px" inline class="FormInput">
        ...
        <el-form-item label="盘盈入库单号：" label-width="105px" prop="warehousingType">
          <el-input
            v-model="dtData.warehousingType"
    ...
    <el-main id="elmain" class="wmltable">
      ...
      >
        ...
        <el-table-column prop="warehousingOrder" label="盘盈入库单号" width="200%" sortable='custom'>
          <template slot-scope="scope">
...
export default {
  name: "viewsinventoryOverflowPutindexvue",
  components: {
    Pagination
  },
  filters: {
  ...
  mounted() {
    ...
    this.pathData = "viewsinventoryOverflowOrderindexvue";
  },
  methods: {
    goPage(item, type) {
      var name = "";
