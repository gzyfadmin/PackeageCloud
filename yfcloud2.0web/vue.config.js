...
var externals = {};
// console.log(process.env.VUE_APP_CURENV)
if (process.env.VUE_APP_CURENV == 'production') {
  name = defaultSettings.title || 'vue Element Admin' // page title
  externals = {
    // 'vue': 'Vue',
...
module.exports = {
  ...
  outputDir: 'dist',
  assetsDir: 'static',
  // lintOnSave: process.env.NODE_ENV === 'development',//可能错误
  lintOnSave: false,//删除代码规范
  ...
  chainWebpack(config) {
    ...
    const cdn = {
      css: [
        ...
        // 'https://cdn.staticfile.org/element-ui/2.12.0/theme-chalk/index.css'
      ],
      js: [
